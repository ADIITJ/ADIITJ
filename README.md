...
|----------------------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|  
| Alex Local AI Assistant                  | A versatile local AI assistant that plays music, shows news, opens apps and files, and engages in chatting. | [![Alex AI Assistant](alex.png)](https://github.com/ADIITJ/Alex-AI-Assisitant)                               |  
| Book Recommendation System               | A web application that recommends books based on user preferences and reading history, utilizing collaborative filtering and content-based filtering techniques. | [![Book Recommendation](book.jpg)](https://github.com/anwesh2410/Book-Recommendation-Site)                     |  
